...
"""
PATHS = [
    r'organize2/铁次5h滞后_19.xlsx',
    r'organize2/铁次5h滞后_20.xlsx',
    r'organize2/铁次5h滞后_201.xlsx',
    r'organize2/铁次5h滞后_all.xlsx',
    r'organize2/铁次5h滞后_缺失填充处理后.xlsx'
]
...
def concat_and_fill():
    ...
    # 去除 缺失程度超过 2成的 样本
    list_lack = list(temp.index[temp.count(axis=1) / temp.shape[1] < 0.8])
    print("去除 缺失程度超过 2成的 样本")
    print(list_lack)
    droped2 = temp.drop(index=list_lack)
