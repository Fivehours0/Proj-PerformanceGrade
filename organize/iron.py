...
CHEMICAL_TABLE_NAME = '西昌2#高炉-上料质量表'
...
def main_legacy(five_lag=True):
    """
    一次性处理所有批次数据的老代码
    :param five_lag:
    :return:
    """
    obj19 = Solution(19, five_lag=five_lag)
    obj20 = Solution(20, five_lag=five_lag)
    obj201 = Solution(201, five_lag=five_lag)
